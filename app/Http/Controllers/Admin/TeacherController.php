...
class TeacherController extends ControllerAbstract
{
    protected $viewFolder = 'pages.admin.teachers';
    protected $routePrefix = 'teachers';

    public function __construct(Model $model)
    {
        $this->model = $model;
        $this->title = 'ttdt.list.teacher';
    ...
    protected function getRules($mode = 'create', $id = null)
    {
        ...
        if ($mode === 'update') {
            $rules['phone'] = "required|numeric|unique:teachers,phone,$id";
        }
        else {
            $rules['phone'] = "required|numeric|unique:teachers,phone";
        }
